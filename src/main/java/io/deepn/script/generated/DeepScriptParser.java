...
public class DeepScriptParser extends Parser {
	...
	public static class StrategyFunctionExpressionContext extends ExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeepScriptVisitor ) return ((DeepScriptVisitor<? extends T>)visitor).visitStrategyFunctionExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MendatoryNamedExpressionListContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeepScriptVisitor ) return ((DeepScriptVisitor<? extends T>)visitor).visitMendatoryNamedExpressionList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MendatoryNamedExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DeepScriptVisitor ) return ((DeepScriptVisitor<? extends T>)visitor).visitMendatoryNamedExpression(this);
			else return visitor.visitChildren(this);
		}
	}
