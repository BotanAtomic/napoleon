...
import esgi.napoleon.utils.toText
...
data class NapoleonExecutionError(
    val type: String,
    val message: String,
...
class NapoleonErrorHandler : BaseErrorListener() {
...
class NapoleonErrorStrategyHandler : DefaultErrorStrategy() {
