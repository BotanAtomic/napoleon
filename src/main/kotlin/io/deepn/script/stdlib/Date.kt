...
object Date {
    ...
    fun DateTimeVariable.nano() = IntegerVariable(this.value.nano)

    fun DateTimeVariable.plusYears(years: IntegerVariable) = DateTimeVariable(this.value.plusYears(years.value))
    fun DateTimeVariable.minusYears(years: IntegerVariable) = DateTimeVariable(this.value.minusYears(years.value))

    fun DateTimeVariable.plusMonths(months: IntegerVariable) = DateTimeVariable(this.value.plusMonths(months.value))
    fun DateTimeVariable.minusMonths(months: IntegerVariable) = DateTimeVariable(this.value.minusMonths(months.value))

    fun DateTimeVariable.plusWeeks(weeks: IntegerVariable) = DateTimeVariable(this.value.plusWeeks(weeks.value))
    fun DateTimeVariable.minusWeeks(weeks: IntegerVariable) = DateTimeVariable(this.value.minusWeeks(weeks.value))

    fun DateTimeVariable.plusDays(days: IntegerVariable) = DateTimeVariable(this.value.plusDays(days.value))
    fun DateTimeVariable.minusDays(days: IntegerVariable) = DateTimeVariable(this.value.minusDays(days.value))

    fun DateTimeVariable.plusHours(hours: IntegerVariable) = DateTimeVariable(this.value.plusHours(hours.value))
    fun DateTimeVariable.minusHours(hours: IntegerVariable) = DateTimeVariable(this.value.minusHours(hours.value))

    fun DateTimeVariable.plusMinutes(minutes: IntegerVariable) = DateTimeVariable(this.value.plusMinutes(minutes.value))
    fun DateTimeVariable.minusMinutes(minutes: IntegerVariable) =
        DateTimeVariable(this.value.minusMinutes(minutes.value))

    fun DateTimeVariable.plusSeconds(seconds: IntegerVariable) = DateTimeVariable(this.value.plusSeconds(seconds.value))
    fun DateTimeVariable.minusSeconds(seconds: IntegerVariable) =
        DateTimeVariable(this.value.minusSeconds(seconds.value))

    fun DateTimeVariable.plusNanos(nanos: IntegerVariable) = DateTimeVariable(this.value.plusNanos(nanos.value))
    fun DateTimeVariable.minusNanos(nanos: IntegerVariable) = DateTimeVariable(this.value.minusNanos(nanos.value))
    ...
    fun DateVariable.plusYears(years: IntegerVariable) = DateVariable(this.value.plusYears(years.value))

    fun DateVariable.plusMonths(months: IntegerVariable) = DateVariable(this.value.plusMonths(months.value))
    fun DateVariable.minusMonths(months: IntegerVariable) = DateVariable(this.value.minusMonths(months.value))

    fun DateVariable.plusWeeks(weeks: IntegerVariable) = DateVariable(this.value.plusWeeks(weeks.value))
    fun DateVariable.minusWeeks(weeks: IntegerVariable) = DateVariable(this.value.minusWeeks(weeks.value))

    fun DateVariable.plusDays(days: IntegerVariable) = DateVariable(this.value.plusDays(days.value))
    fun DateVariable.minusDays(days: IntegerVariable) = DateVariable(this.value.minusDays(days.value))
    ...
    fun TimeVariable.nano() = IntegerVariable(this.value.nano)
    ...
    fun TimeVariable.plusNanos(nanos: IntegerVariable) = TimeVariable(this.value.plusNanos(nanos.value))
    fun TimeVariable.minusNanos(nanos: IntegerVariable) = TimeVariable(this.value.minusNanos(nanos.value))
